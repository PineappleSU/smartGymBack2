 ...
 */
@Service
public class OldPlayerServiceImpl implements OldPlayerService {
...
//		player.setEventId(String(apply.getItemId());
...
//			criteriaItemIds.andEventIdNotIn(itemIds);
...
//			criteria.andEventIdEqualTo(itemId);
...
//		genRank(playerMapper.selectByPrimaryKey(player.getId()).getEventId(), type);
...
//		criteria1.andEventIdEqualTo(itemId);
...
//		criteria21.andEventIdEqualTo(itemId);
...
//		criteria22.andEventIdEqualTo(itemId);
...
//		criteria23.andEventIdEqualTo(itemId);
...
//			criteria.andEventIdIn(Arrays.asList(itemIds));
...
//		Item item = itemService.getItemByItemIdAndStatuses(player.getEventId());
