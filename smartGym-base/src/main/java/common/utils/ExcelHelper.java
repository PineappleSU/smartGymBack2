...
public class ExcelHelper {
	public static String[] playersExcelTitleArray = new String[] { "工号","姓名","职责","负责比赛","负责项目"};
	//比赛成绩表
	public static String[] playersDetailedExcelTitleArray = new String[] { "参赛号", "学号", "姓名", "性别",
			"学院", "赛事", "类别", "项目","组别", "职责", "组号", "道次", "成绩", "排名", "备注" };
	//报名表
	public static String[] applicationsExcelTitleArray = new String[] { "学号", "姓名", "性别", 
			"学院", "赛事", "类别", "项目","组别", "职责", "状态", "备注" };
	//工作人员表
	public static String[] workersExcelTitleArray = new String[] {"工号","姓名","职责","负责比赛","负责项目"
	};
	/**
	 * //将数据写入文件 by zh
	 * 
